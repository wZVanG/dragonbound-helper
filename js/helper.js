...
function Helper(){
	...
	this.initDOM = function(){
		...
		mobile_button.selectList({items: mobileItems, id: 'mobileListWrap', clickItem:function(key){
		...
		map_button.selectList({items: maplist, id: "mapListWrap", renderItem: function(index,key,text){
			var el = $(this)
...
function gp(){
	...
	*/
	...
	$.getJSON("http://dragonboundaimbot.com/app/power",{d:args.map(function(a){return ~~(+a)}).join(","),k:"daaf64feaaa5e6ffeef4ffaafdccd52a"}, function(data){
